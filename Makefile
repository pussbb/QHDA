...
# Generated by qmake (2.01a) (Qt 4.7.2) on: ?? ??? 9 23:04:30 2011
# Project:  QHDA.pro
# Template: app
...
SOURCES       = main.cpp \
		...
		src/bookwizard.cpp obj/moc_qhda.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/QHDA1.0.0/ && $(COPY_FILE) --parents headers/qhda.h headers/qcorewindow.h headers/databasemanager.h extras/dbmanagerinterface.h headers/bookwizard.h obj/QHDA1.0.0/ && $(COPY_FILE) --parents resource/qhda.qrc obj/QHDA1.0.0/ && $(COPY_FILE) --parents main.cpp src/qhda.cpp src/qcorewindow.cpp src/databasemanager.cpp src/bookwizard.cpp obj/QHDA1.0.0/ && $(COPY_FILE) --parents ui/qhda.ui ui/bookwizard.ui obj/QHDA1.0.0/ && $(COPY_FILE) --parents lang/qhda_ru.ts lang/qhda_def.ts lang/qhda_en.ts obj/QHDA1.0.0/ && (cd `dirname obj/QHDA1.0.0` && $(TAR) QHDA1.0.0.tar QHDA1.0.0 && $(COMPRESS) QHDA1.0.0.tar) && $(MOVE) `dirname obj/QHDA1.0.0`/QHDA1.0.0.tar.gz . && $(DEL_FILE) -r obj/QHDA1.0.0
...
compiler_moc_header_make_all: obj/moc_qhda.cpp obj/moc_qcorewindow.cpp obj/moc_databasemanager.cpp obj/moc_bookwizard.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) obj/moc_qhda.cpp obj/moc_qcorewindow.cpp obj/moc_databasemanager.cpp obj/moc_bookwizard.cpp
